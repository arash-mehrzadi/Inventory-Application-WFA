...
{    
    public partial class Main : Form
    {
        ...
        private void FluctutionControl_Click(object sender, EventArgs e)
        {
            ...
            OpenChildForm(new FormDatacenter());
        }

        private void Repo_Click(object sender, EventArgs e)
        {
            ActiveButton(sender, RGBColors.color2);
            OpenChildForm(new FormAddData());
        }
        ...
        private void menucontrol_Click(object sender, EventArgs e)
        {
            if(menucontrol.IconChar == IconChar.Bars )
            {
                ...
                btnPocket.Text = "Not Available";
                btnCalculation.Text = "Not Available";
                btnTechnicalMonitor.Text = "HW.1";
                btnClassicMonitor.Text = "Report";
                btnalgo1.Text = "Add";
                btnfilemanager.Text = "Data Center";
                panelMenu.Size = new Size(189, 443);
                //btnSetting.Size = new Size(189, 50);
                //btnPocket.Size = new Size(189, 50);
                //btnfilemanager.Size = new Size(189, 50);
                //btnClassicMonitor.Size = new Size(189, 50);
                //btnalgo1.Size = new Size(189, 50);
            ...
            else
            {
                ...
                btnalgo1.Text = "";
                btnfilemanager.Text = "";
                panelMenu.Size = new Size(48, 443);
